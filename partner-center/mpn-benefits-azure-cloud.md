...
Ez a cikk a partnerek számára elérhető Azure- és felhőbeli előnyöket ismerteti a Partnerközpont. Azt is megtudhatja, hogyan aktiválhatja az Azure- és felhőalapú előfizetések bizonyos típusait.
...
- Az Azure & elérhető különböző felhőalapú termék-előfizetési előnyök, akár licencalapú előfizetések, akár használatalapú előfizetések
- Az egyes termékekhez rendelt licencmennyiség
- Az ajánlat típusa, amely egy adott kedvezményterméket adott ki Az Ön számára
- Az előny típusa (akár magból, akár növekményesből származik)
- Egy adott juttatás lejáratának dátuma
...
### <a name="usage-based-subscriptions-with-two-types-of-microsoft-azure-credit"></a>Használatalapú előfizetések kétféle típusú Microsoft Azure kreditekkel
...
- Amikor tömeges (éves) Azure-kreditet rendel  hozzá, vegye figyelembe, hogy az Eltávolítás lehetőség nem érhető el a Partnerközpont. Ehelyett át kell ruházni a csoportos kreditet valaki másnak a regisztrációs év során. Az Azure tömeges (éves) kredit-előfizetése nem kombinálható más licencelési, előre fizetett vagy jóváírási ajánlatokkal (például Microsoft Nagyvállalati Szerződés, Felhőszolgáltató, Azure in Open licencprogram, Azure Pass, Microsoft Action Pack stb.).

### <a name="license-based-subscriptions"></a>Licencalapú előfizetések

Az Azure- és Felhőalapú termékek oldal licencalapú előfizetések szakaszában minden olyan felhőalapú terméket megtalál, amely termékkulcsot igényel az aktiváláshoz, például a Microsoft O365, a Microsoft Dynamics, Microsoft Intune, az Azure AD alapszintű, Power BI stb. Ezek a termékek a partnerként elérhető aktív ajánlat típusa alapján érhetők el a Microsoft Partner Network. Ilyen ajánlat lehet a Microsoft Action Pack, a Silver kompetenciatagság vagy a Gold kompetenciatagság.

Licencalapú előfizetés aktiválása: 

1. Keresse meg az adott előfizetést az Azure- és felhőalapú termékek oldalon. 
...
1. Az oldalpanelen válassza a **Termékkulcs beváltása lehetőséget.** 

1. Adja meg a termékkulcsot, majd válassza az **Érvényesítés lehetőséget** a kulcs részleteinek ellenőrzéséhez. 
...
Ha először aktivál egy előfizetést, kövesse az alábbi lépéseket. Akkor is használhatja ezeket a lépéseket, ha az előfizetése le van tiltva vagy lejárt állapotban van:

1. Másolja és illessze be az alábbi hivatkozást egy privát vagy **inkognitó módú böngészőablakba.**
   
   [https://signup.microsoft.com/productkeystart](https://signup.microsoft.com/productkeystart)
1. Győződjön meg arról, hogy a megfelelő bérlőfiókba Azure Active Directory be. Miután bejelentkezett, ellenőrizze a bérlő adatait.
...
Ha 100 aktív licenccel rendelkezik egy előfizetésben, és 25 licenccel rendelkező kulccsal próbálja meghosszabbítani a záró dátumot, a záró dátum három (3) hónappal lesz meghosszabbítva a 100 licenccel rendelkező előfizetésre.

### <a name="scenario-2"></a>2\. példa

Ha 100 aktív licenccel rendelkezik egy előfizetésben, és egy 100 licenccel rendelkező kulccsal próbálja meghosszabbítani a záró dátumot, a záró dátum 12 hónappal lesz meghosszabbítva.

### <a name="scenario-3"></a>3\. példa

Ha öt (5) licenc aktív egy előfizetésben, és egy 10 licenccel rendelkező kulccsal próbálja meghosszabbítani a záró dátumot, a záró dátum öt (5) licenccel (vagy főkiszolgálóval) meghosszabbítható 24 hónappal az előfizetésre.

### <a name="scenario-4"></a>4\. példa

Ha a záró dátumot egy 3x aktív licencnél/helynél több aktív licenccel/főkiszolgálóval rendelkező kulccsal próbálja meghosszabbítani, az alábbi hibaüzenet jelenik meg. Ez az üzenet a terv szerint jelenik meg, mivel az előfizetés záró dátuma legfeljebb 3 évvel hosszabbható meg.

:::image type="content" source="images/benefits/mpn-benefits-azure-cloud-6.png" alt-text="Azure- és felhőalapú termékek hibaüzenete." border="false":::

## <a name="next-steps"></a>Következő lépések

- További információ az [Office 365 E3-ból a Microsoft 365 Premium verzióba való áttelepítésről](/microsoft-365/business/migrate-from-e3)
