...
Partneri hivatkozó állapota|Yes|A vállalat szemszögéből vonatkozó üzlet állapotát jelzi. Szükséges, ha egy hivatkozót próbál létrehozni vagy módosítani. Ha új üzletet próbál létrehozni, használja az **új** lehetőséget. Az elfogadott [értékek dokumentálva](https://docs.microsoft.com/partner/develop/referral-resources#referralstatus)vannak.|Aktív
Partner átirányítási alállapota|Yes|Az üzlet pontos állapotát jelzi. Ha új üzletet próbál létrehozni, **fogadja el** a használatát. Akkor is szükség van rá, ha módosít egy meglévő átirányítást. Az elfogadott [értékek dokumentálva](https://docs.microsoft.com/partner/develop/referral-resources#referralsubstatus)vannak.|Elfogadva
...
Értékesítési fázis|No|Ez a mező jelzi az átirányítás részletes értékesítési szakaszát. További információ az [értékesítési szakaszokról](https://aka.ms/salesStages)|40
