...
- Az MPN-hez társított globális rendszergazda vagy MPN-partneradminisztrát a technikai támogatási előnyök aktiválásához.
- Bármely MPN-hez társított felhasználói fiók az aktiválás után a hozzáférési azonosító és a szerződésazonosító megtekintéséhez.
- Rendszergazdai ügynök, hogy támogatást hozzon létre az ügyfél nevében a felhőalapú termékekhez.
- Bármely fiók, AAD vagy MSA, amely helyszíni támogatási kéréseket hoz létre az ügyfél vagy a saját szervezete nevében.

## <a name="overview"></a>Áttekintés

A [Műszaki előnyök](https://partner.microsoft.com/dashboard/mpn/membership/benefits/technical) lap két különböző előnyt mutat be:

1. **Technikai terméktámogatási incidensek – lásd alább**
2. Műszaki előzetes és üzembe helyezési szolgáltatások (TPD) – [további információ](technical-benefits.md)

Ez a cikk az Microsoft Partner Network (MPN) tagjainak van, akiknek szükségük van a műszaki előnyeik aktiválására, a hozzáférési azonosítók és a szerződésazonosítók megtekintésére, a támogatott termékek és verziók megtekintésére, valamint a technikai támogatási incidensek/jegyek MPN-partneri előnyöket használó létrehozási folyamatának elkezdésére

### <a name="steps"></a>Lépések

1. Aktiválja a műszaki előnyeit (globális rendszergazda vagy MPN-partneradminisztrát szükséges hozzá). Aktiválás után az összes MPN-felhasználói fiók megtekintheti a hozzáférési azonosítót és a szerződésazonosítót, hogy az előnyöket a fiókjához társítsa

2. Tekintse meg a műszaki támogatásra vonatkozó jogosultságot és a támogatott termékeket, és ellenőrizze, hogy az MPN-előnyök használhatók-e a kívánt termékhez és verzióhoz

3. Microsoft-terméktámogatás (a legutóbbi helyszíni termékekhez): A Vállalati támogatás használata helyszíni terméktámogatáshoz

4. Signature Felhőtámogatás (felhőalapú termékekhez): A Rendszergazdai ügynök szerepkört használó felhasználók az **Ügyfelek** és szolgáltatáskezelés lehetőséget választva hozhatnak létre kérést. Tekintse meg az alábbi részleteket az egyes lépésekről:

## <a name="view-and-activate-your-technical-support-benefits"></a>A műszaki támogatási előnyök megtekintése és aktiválása

A műszaki előnyök megtekintése vagy aktiválása a Partnerközpont:
...
## <a name="technical-support-entitlement-and-supported-products"></a>Műszaki támogatás jogosultsága és támogatott termékek

A technikai támogatás hibaelhárítást biztosít egy adott problémához, hibaüzenethez vagy funkcióhoz, amely nem a várt módon működik. Az MPN terméktámogatása és Signature Felhőtámogatás a Microsoft adott termékeihez és verzióihoz is használható (nem minden termék és verzió támogatott).

> [!NOTE]
> A műszaki támogatási előnyöket aktiválni kell a használatuk előtt.

A partneri Microsoft Partner Network a következő technikai támogatásra jogosultak
...
Bármely felhasználói fiók (AAD vagy MSA) műszaki támogatást használhat a on-premise termékekhez, ha rendelkezik hozzáférési azonosítóval és szerződésazonosítóval

Válassza [a Vállalati támogatás lehetőséget](https://support.serviceshub.microsoft.com/supportforbusiness/create) egy támogatási kérés létrehozásához egy adott termékhez.
...
## <a name="signature-cloud-support-cloud-only"></a>Signature Felhőtámogatás (csak felhőben)
