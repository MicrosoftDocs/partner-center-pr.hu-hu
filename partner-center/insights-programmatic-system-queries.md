...
---
# <a name="list-of-system-queries-for-partner-insights-programmatic-access"></a>Rendszerlekérdezések listája partnerelemzési programozott hozzáféréshez

A következő rendszerlekérdezések használhatók a Jelentés létrehozása [API-ban](insights-programmatic-access-paradigm.md#create-report-api) közvetlenül egy QueryId-val. A rendszerlekérdezések hasonlóak az exportálási jelentésekhez Partnerközpont hat hónapos (6 millió) számítási időszakra vonatkozóan.

Az oszlopnevekkel, attribútumokkal és leírással kapcsolatos további részletekért tekintse meg az [adatdefiníciókat ismertetőt](insights-data-definitions.md)

Az alábbi szakaszok különböző jelentésekhez nyújtanak jelentéslekérdezeket.

## <a name="customers"></a>Ügyfelek

Az ügyfelek jelentése az elmúlt hat hónapra

Lekérdezés azonosítója: `6664daf3-c161-423a-92a1-0ea6db2c0384`

### <a name="report-query"></a>Jelentéslekérdezés
```sql
...
## <a name="seats-subscriptions-and-revenue"></a>Helyek előfizetései és bevétele

Helyek, előfizetések és bevételi jelentés az elmúlt hat hónapra

Lekérdezés azonosítója: `c9fc1c79-4408-49ff-97f9-e1aa3f155804`
...
Lekérdezés azonosítója: `e65f3a4f-fb99-4319-97ff-59e57566a871`
...
AzureUsage-jelentés az elmúlt hat hónapra

Lekérdezés azonosítója: `d1a4d75e-5ca8-4847-845f-ee0a9be6f07b`
...
## <a name="office-usage"></a>Office Használat

OfficeUsage-jelentés az elmúlt hat hónapra

Lekérdezés azonosítója: `d8349f7b-a7d1-467e-b26d-434d4a50f26a`
...
## <a name="dynamics-usage"></a>Dynamics-használat

DynamicsUsage-jelentés hat hónapra

Lekérdezés azonosítója: `6209a8fd-93af-442e-8b3f-3df0f77e8463`
...
## <a name="power-bi-usage"></a>Power BI-használat

PowerBIUsage jelentés hat hónapra

Lekérdezés azonosítója: `40ebfe2f-7183-4427-a911-5c9b45b6df15`
...
## <a name="ems-usage"></a>EMS-használat

HAT hónapos EMSUsage-jelentés

Lekérdezés azonosítója: `d7f20ea4-8751-4d6b-b1d7-821c316acd6a`
...
## <a name="competency-performance-requirement-report"></a>Kompetenciateljesítményre vonatkozó követelmények jelentése

KompetenciaPeformanceRequirement jelentés hat hónapra

Lekérdezés azonosítója: `3a0e1adc-f5c1-42ac-9422-8e944bf81ae5`
...
## <a name="cloud-products-reseller-performance"></a>Felhőalapú termékek viszonteladói teljesítménye

### <a name="report-description"></a>Jelentés leírása

CloudProductsResellerPerformance jelentés hat hónapra

Lekérdezés azonosítója: `c09c2eda-861b-4664-8ee8-48a14745a26a`
...
## <a name="clas-agreement-renewal-propensity"></a>CLAS-szerződés megújításának propensitása

CLASAgreementRenewalsPropensity jelentés hat hónapra

Lekérdezés azonosítója: `c4fc87ac-4cca-44cd-bf4d-835ac513f9ee`
...
## <a name="clas-azure-propensity"></a>CLAS Azure-propensitás

CLASAzurePropensity jelentés hat hónapra

Lekérdezés azonosítója: `9a18bd70-8f90-4bd2-8266-5f6e453e3ee7`
...
## <a name="clas-d365-propensity"></a>CLAS D365 propensitás

CLASD365Propensity jelentés hat hónapra

Lekérdezés azonosítója: `258fdcac-6e9c-4072-af27-b1b3d97be16c`
...
## <a name="clas-m365-propensity"></a>CLAS M365-propensitás

CLASM365Propensity jelentés hat hónapra

Lekérdezés azonosítója: `fbe00e32-fdde-4465-b3e4-41bbd021a130`
...
## <a name="teams-usage-3p-apps"></a>Teams Használat 3P-alkalmazások

TeamsUsage3PApps jelentés hat hónapra

Lekérdezés azonosítója: `42d287be-cc76-4109-a066-f3140ad97fe2`
...
## <a name="teams-usage-workload"></a>Teams számítási feladat

TeamsUsageWorkload jelentés hat hónapra

Lekérdezés azonosítója: `817fe875-acb0-4c45-9201-b7a35a60235a`
...
## <a name="teams-usage-meetings-and-calls"></a>Teams értekezletek és hívások

TeamsUsageMeetingsAndCalls jelentés hat hónapra

Lekérdezés azonosítója: `b7bd73a8-47e8-4c57-b915-445708cfd7bf`
...
## <a name="competency-summary-history"></a>Kompetencia összegző előzményei

KompetenciaSummaryHistory jelentés hat hónapra

Lekérdezés azonosítója: `fddab2aa-523d-47f6-90fe-588557306db4`
...
## <a name="training-completion"></a>Betanítás befejezése

Hat hónapos betanítás befejezési jelentése

Lekérdezés azonosítója: `20f5da57-3c2a-481b-b6a0-ec34d6db14e2`
...
Microsoft Learn az elmúlt hat hónapra vonatkozó jelentés

Lekérdezés azonosítója: `0e06c7c3-75ab-4cd5-8178-8cf1a2de49cc`
...
- [Mintaalkalmazás a partnerelemzési adatok eléréséhez](insights-programmatic-sample-application.md)