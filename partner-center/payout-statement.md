...
:::image type="content" source="images/payouts/payout-overview.png" alt-text="A portál jobb felső sarkában található Kifizetés ikont Partnerközpont be.":::

A Partner Payout [API-val](/rest/api/partner-center/partner-payouts) közvetlenül is csatlakozhat a kifizetési tranzakciókhoz és a fizetési adatokhoz, és beszerezheti őket. További információ: [Kifizetések kezelése a Payout Service API-val.](/partner-center/develop/manage-payouts)
...
- **Idei elküldött bevételek** – A következő hónapban kifizetett és kifizetendő bevételek teljes összege és lebontása.
...
A bevételről további részleteket az oldal jobb oldalán található lefelé mutató nyílra kattintva talál. Ez megjeleníti a mozgatókart, a bevételi összeget, a terméket és az ügyfelet. Ha ezek az adatok valamilyen okból nem érhetők el, de hozzá kell férni, forduljon az ügyfélszolgálathoz. Ha a bevétel egy módosítás eredménye, nem pedig egy tranzakció, akkor a Product és a Customer mező nem jelenik meg.
...
- **Bevétel típusa** – A bevétel típusa, például Értékesítés, Épész vagy Együttműködés.
...
A bevételi tranzakciók akkor jelennek meg, ha a tranzakció megfelel a kifizetési jogosultságnak. Ha meg tudja érteni, miért hiányoznak vagy váratlan bevételek, tekintse meg a kereskedelmi piactéri kifizetésekkel kapcsolatos gyakori [kérdéseket.](payout-faq.yml#why-are-my-earnings-missing-)

#### <a name="estimated-payment-month"></a>Becsült kifizetési hónap

A Tranzakciós előzmények oldal mostantól tartalmaz egy táblázatot, amely a következő néhány hónap becsült kifizetésének összegét mutatja. Ezt az információt a Tranzakcióelőzmények és az Összefoglalás jelentés exportálási táblázatában is megtekintheti és letöltheti. Ezek az információk megkönnyítik az egyeztetéseket és a fizetési előrejelzéseket.
...
- A bevételeknek el kell tartaniuk vagy meg kell haladni a program útmutatójában meghatározott minimális bevételi küszöbértéket.
...
>
>- **lastPaymentCurrency (lastPaymentCurrency)**  Az a pénznem, amelyben a legutóbbi fizetés érkezett az összes olyan MPN-ről, amelyhez a jelenleg bejelentkezett partner hozzáfér. Ha nem érkezik kifizetés, az utolsó fizetési pénznem amerikai dollár lesz.
>- **earningAmountInLastPaymentCurrency**  A bevétel összege az utolsó fizetési pénznemben.

| Oszlop neve | Leírás | Az ösztönző programok/piacterek alkalmazhatósága |
| --- | --- | --- |
...
| distributorId (forgalmazóazonosító) | Terjesztő azonosítója | Ösztönzők – csak néhány program |
| distributorName (forgalmazó neve) | Terjesztő neve | Ösztönzők – csak néhány program |
| earningAmount | Bevételi összeg az eredeti tranzakciós pénznemben | Mind |
| earningAmountInLastPaymentCurrency | Bevételi összeg az utolsó fizetési pénznemben (a mező üres lesz, ha még nem fizették ki a korábbi kifizetéseket) |  |
| earningAmountUSD | Bevétel USD-ben | Mind |
| bevételDátum | A bevétel dátuma | Mind |
| earningExchangeRate | Exchange USD összegének megjelenítése | Mind |
| earningId (bevételazonosító) | Az egyes bevételeket azonosító egyedi azonosító | Mind |
| earningRate | A bevétel generálása érdekében a tranzakció összegére alkalmazott ösztönzők aránya | Mind |
| earningType (bevétel típusa) | Jelzi, hogy a díj, az előfizetés, az együttműködés, az értékesítés és így tovább | Mind |
| exchangeRateDate | Exchange usd kiszámításához használt árfolyamdátum | Mind |
...
| LineItemId (Sorazonosító) | Az ügyfél számlájának egyéni sora |  |
...
| parentProductName (parentProductName) | A szülőtermék neve. Ha a tranzakciónak nincs szülőterméke, akkor a Szülő termék neve = Terméknév. | Piacokon |
...
| Programkód | A program nevével leképezni következő sztring |  |
...
| subscriptionStartDate (Előfizetés kezdődátum) | Előfizetés kezdő dátuma | Ösztönzők – csak néhány program |
| taxCity (adóváros) |  |  |
| taxCountry (ország) |  |  |
| taxRemitModel | Az adók (értékesítés, használat vagy áfa/GST-adók) átutalásáért felelős fél | Piacokon |
| taxRemitted (adó leírva) | A kivetített adó mennyisége (értékesítés, felhasználás vagy áfa/GST-adók) | Piacokon |
...
| transactionExchangeRate | Exchange usd összegének a megfelelő tranzakciós összegére vonatkozó árfolyamdátum megjelenítése | Mind |
...
>[!Note]
> Ahhoz, hogy jogosult legyen a kifizetésre, a bevételnek el kell érnie az 50 usd fizetési küszöbértéket. [](payment-thresholds-methods-timeframes.md) További információért tekintse meg a Microsoft Publisher [szerződését.](/legal/marketplace/msft-publisher-agreement)
...
Ha meg kell értenie, hogy miért hiányoznak vagy váratlan bevételek, tekintse meg a kereskedelmi piactéri kifizetésekre vonatkozó gyakori [kérdéseket.](payout-faq.yml#why-are-my-earnings-missing-)
...
| Helytelen fizetés | Folyamatban van a fizetés újrafizetése. | No |
| Elküldött | A kifizetés el lett küldve a banknak. | No |
| Újrafeldolgozási | A kifizetés során a Microsoft rendszerhiba lépett fel, és folyamatban van az újrafeldolgozás. | No |
| Reversed | A kifizetést a bank visszavonta, és a következő fizetési ciklusban újra elküldjük. | No |
| Elutasított adószámla | Az adószámla el lett utasítva a felülvizsgálat során. Az összes függőben lévő kifizetés fel lesz függve az adószámla áttekintésének befejezéséig. | Részletekért forduljon a Microsoft ügyfélszolgálatához |
| Adózási számla felülvizsgálat alatt | Az adószámla felülvizsgálata folyamatban van. A kifizetését az adószámla jóváhagyása után felszabadítjuk. | No |
| Elutasítva | A kifizetést a bank elutasította. | Részletekért forduljon a bankhoz. |
|
...
| teljes fizetés | Teljes kifizetés helyi pénznemben, a visszatartott adó nélkül, valamint a program/résztvevőazonosító értékesítési adójának (ha van) beleértve |
| currencyCode | Fizetés pénznemkódja |
...
| paymentStatus (kifizetésiállapot) | Fizetési állapot |
| paymentStatusDescription (kifizetési leírás) | A fizetési állapot rövid leírása |
| paymentDate (fizetésidátum) | A Fizetés Microsofttól való elküldének dátuma |
|

## <a name="export-data"></a>Adatok exportálása

Az **Adatok exportálása** lap nem frissül egyedül. Előfordulhat, hogy manuálisan kell frissítenie az oldalt a legfrissebb adatokhoz. Válassza ki a három lapfület a **Tranzakciós** előzmények, a **Kifizetések,** a **Tranzakció összegzése** vagy a korábbi **kimutatás exportálására.**

Előfordulhat, hogy a szűrő **"Nincs elérhető adat" hibaüzenetet** eredményez. Ez akkor fordulhat elő, ha az alapértelmezett időszakot három hónapra jelölte ki, majd az adott időszakon kívüli bevételből kiválasztott egy fizetési azonosítót. Ha ez történik, bontsa ki az időszakot, és próbálkozzon újra.
...
- Az örökölt tranzakcióelőzmények egyik oszlopa a "Fenntartott", amely a modern előzmények "Bevételek" oszlopának felel meg, azzal a kivételsel, hogy kizárja az összes olyan bevételt, amelynek állapota "Payment Sent" (Fizetés elküldve).
...
| Mennyiség | Ha a Revenue Source (Bevétel forrása) Microsoft Store Vállalatoknak, a Quantity (Mennyiség) a megvásárolt licencek számát jelöli. Minden más bevételi forrás esetén a Mennyiség mindig 1 lesz. Még ha egyetlen tranzakció két sorelemre is fel van osztva, mert két különböző fizetési módot használtak, minden sortételnél 1 mennyiség fog mutatni. |
...
| Fizetési mód | A tranzakcióhoz használt ügyfél fizetési eszköze, például kártya, mobilszolgáltatói számlázás vagy PayPal |
...
| Nettó nyugták | A tranzakció összege a ki nem küldött adóval kevesebb |
...
| Adóremit modell | Az adók (értékesítés, felhasználás vagy áfa-/GST-adók) átutalásáért felelős fél |
| Jogosultság dátuma és ideje | A tranzakció bevételének dátuma és időpontja jogosulttá válik kifizetésre (UTC). A kifizetési folyamat a kifizetési dátum előtti jogosultsági dátummal (csak a Fenntartott  CSV-fájlban található) tartalmazza a tranzakciókat. |
| Díjak | A Transaction Amount (Tranzakció összege) oszlopban összesített összes díj részleteinek lebontását jeleníti meg (csak az Azure Marketplace, a **Reserved** CSV-fájlban nem szerepel). |
|||
