...
Amikor készen áll egy fiók létrehozására a Partnerközpont, a következő elemekre lesz szüksége.  Az első lépésekhez néhány percet is igénybe vehet, mire összegyűjti ezeket az elemeket:
...
1. Az Első [**lépések oldalon**](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/partnership) kezdje azzal a munkahelyi e-mail-címmel, amelyet a vállalata adott Önnek ,például: you@yourcompanyname.com .
    ...
    a.  Az e-mail-címnek érvényesnek és elérhetőnek kell lennie, mert a folytatáshoz egy ellenőrző kódot küldünk erre az e-mail-címre.
...
Keresse meg a céges profilját, vagy adja meg manuálisan a vállalati adatokat. Ha a vállalata regisztrálva van [a & Bradstreet](https://partner.microsoft.com/marketing/usisvshowcase/dunandbrad)nevű cégnél, a CÉGes adatok ki- és lekért azonosítójával keresse meg. Ha saját maga szeretné biztosítani a céges adatokat, válassza a **Manuális lehetőséget.**

Ha a vállalata a Következő helyen **található:** Gyojomcsomónia, **Kirgizisztán**, **Ander,** **Uzbekistan** vagy **Oroszország**, és ön manuálisan adja meg a címét, akkor a címét érvényesítjük Önnek.  Ha a megadott cím eltér az ellenőrzött címtől, javasoljuk, hogy az ellenőrzött címet használja. Ez biztosítja, hogy a cím elemei az ország postai címe által meghatározott módon szabványosítottak, helyesen formázottak és szállíthatóak.  
...
Ha Ön közvetett szolgáltató, közvetlen számlázási partner vagy közvetett viszonteladó, és a következő országokban új vagy meglévő ügyfelekkel üzleti kapcsolatban áll, meg kell adnia a cég regisztrációs azonosítószámait. Ha az az ország, ahol a vállalkozása található, nem szerepel az alábbi listában, a regisztrációs azonosító megadása nem kötelező.

Az alábbi táblázat az egyes országokhoz gyűjtött regisztrációs számok mintáit tartalmazza. Olyan esetekben, amikor több listában szerepel, csak egy szükséges.

| **Ország vagy régió** | **Részletek** | 
|:--|:--|
| **Örményország** | INN – Adóazonosító szám<br>Áfaszám – Más néven áfaregisztrációs szám. Ez az egyedi szám azonosítja az áfabevallásra regisztrált, adózható (üzleti) vagy nem adózható jogi személy azonosítóját.<br>Nyilvános szolgáltatás száma |
...
| **Belarusz**  | UNP – Ez egy kilencjegyű szám (szervezetek numerikus száma, egyéni személyek számára alfanumerikus szám), amely egy régióazonosítót, régiónkénti sorozatszámot és egy ellenőrző számjegyet tartalmaz. |
|**Brazília** | [CNPJ](http://www.oecd.org/tax/automatic-exchange/crs-implementation-and-assistance/tax-identification-numbers/Brazil-TIN.pdf) – (Cadastro Merto Pessoa Juciodica vagy National Registry of LegalNtities). Ez egy brazíliai vállalatoknak kiadott azonosító szám, amelyet Brazília szövetségi bevételi részlege adott ki  |
...
| **Lengyelország**  | [TIN](http://www.oecd.org/tax/automatic-exchange/crs-implementation-and-assistance/tax-identification-numbers/Poland-TIN.pdf) – Adóazonosító szám<br>[PESEL](http://www.oecd.org/tax/automatic-exchange/crs-implementation-and-assistance/tax-identification-numbers/Poland-TIN.pdf) – Az országos azonosító szám, amely a Következőben használatos: Lengyel Powszechny Elektronisarny System Ewidencji Ludnoncci, Universal Electronic System for Registration of the Population) |
| **Oroszország**  | [INN](http://www.oecd.org/tax/automatic-exchange/crs-implementation-and-assistance/tax-identification-numbers/Russia-TIN.pdf) – Adóazonosító szám (orosz "Individualiy Nomer Nalogoplatelshika") |
...
| **Egyesült Arab Emírségek** | Adóazonosító<br>[Áfaszám](http://www.oecd.org/tax/automatic-exchange/crs-implementation-and-assistance/tax-identification-numbers/UAE-TIN.pdf) – Más néven áfaregisztrációs szám. Ez az egyedi szám azonosítja az áfabevallásra regisztrált, adózható (üzleti) vagy nem adózható jogi személy azonosítóját. |
...
-  [Értékesítési érdeklődők lekért és kezelése a Microsofttól](manage-leads.md)
