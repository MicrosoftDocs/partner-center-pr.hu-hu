...
1. Győződjön meg arról, hogy a Partnerközpont és MPN-azonosítóban lévő partnerprofil aktuális.
...
## <a name="while-you-transition-from-direct-to-indirect-reseller"></a>A közvetlen viszonteladóról a közvetett viszonteladóra való váltás során
...
A regisztráció után a bal oldali navigációs sávon megjelenik a közvetett szolgáltatókra mutató hivatkozás. Közvetett viszonteladóként kapcsolatot fog létesíteni egy közvetett szolgáltatóval, aki ezután képes kezelni a számlázást, termékeket vásárolni az ügyfelek számára, és támogatási infrastruktúrát.
...
- Kezelheti a használati feltételeket és a jóváírási feltételeket
...
Önnek és a közvetett szolgáltatónak is viszonteladói kapcsolatra van szüksége az ügyfelekkel. Ezekkel a viszonteladói kapcsolatokkal kezelheti az ügyfelek előfizetését és szolgáltatásait a nevükben. Ha egy meglévő Azure AD-bérlővel rendelkezik új ügyfelet, meghívhatja az ügyfelet, hogy egyszerre hozzon létre viszonteladói kapcsolatot Ön és a szolgáltató között.

Közvetett viszonteladói meghívó létrehozása:
...
A közvetlen számlázási partnerektől eltérően a közvetett viszonteladók nem hozhatnak létre Azure AD-bérlőket az új ügyfeleik számára a Partnerközpont. A szolgáltató létrehozza a bérlőt, és Ön lesz az ügyfél közvetett viszonteladója. Ez biztosítja, hogy az ügyfél megjelenik az Ön ügyféllistán a Partnerközpont.

>[!Note]
>A közvetlen számlázási funkcióját nem használhatja arra, hogy vásárlásokat hozzon létre a közvetett viszonteladóként beszerzett ügyfelek számára.
...
Ön másképp kezeli a közvetlen számlázási ügyfeleket és a közvetett viszonteladói ügyfeleket.

### <a name="direct-bill-customers-things-you-wont-do-as-an-indirect-reseller"></a>Közvetlen számlázási ügyfelek (olyan dolgok, amelyekre nem közvetett viszonteladóként lesz képes)

- Termékek rendelésének létrehozása
- Az Azure Reservations kezelése
- Rendelési előzményeik kezelése
- Szoftver vásárlása
- Ügyfelek közvetlen számlázása

### <a name="indirect-reseller-customers"></a>Közvetett viszonteladói ügyfelek

- A közvetett szolgáltató termékeket rendel az ügyfeleinek
- Ügyféllicencek és -felhasználók kezelése
- Előfizetés megújításának kezeléséhez

### <a name="to-identify-customers-that-you-acquired-as-a-direct-bill-partner"></a>A közvetlen számlázási partnerként beszerzett ügyfelek azonosítása

1. Válassza az **Ügyfelek** lehetőséget.

2. Válasszon ki egy ügyfelet a részleteik megtekintéséhez.

3. Ha ezt az ügyfelet közvetlen számlázási partnerként szerezte be,  látni fogja a termékek hozzáadásának vagy megtekintésének lehetőségeit, valamint az előfizetéseiket. 
...
5. Kattintson a **Mentés gombra, és folytassa a gombra.**
...
5. Miután az ügyfél engedélyezte Önnek és a szolgáltatónak, hogy a rekord viszonteladója legyen, rendszergazdai engedélyekkel fog rendelkezni az előfizetések, licencek és felhasználók kezeléséhez a nevükben, és a közvetett szolgáltató be tudja majd nyújtani a rendeléseket a nevükben.

6. Az ügyfél fiókjának, szolgáltatásainak, felhasználóinak és licencének kezeléséhez bontsa ki az ügyfél rekordját a név melletti lefelé mutató nyílra kattintva.

### <a name="microsoft-customer-agreement-acceptance"></a>Microsoft Ügyfélszerződés elfogadása
...
- **Az ügyfél elfogadta a Microsoft Ügyfélszerződés a felügyeleti központon Microsoft 365 keresztül**

   Az elfogadás a közvetett szolgáltatóval való viszonteladói kapcsolat létrejötte után is megmarad. Semmit nem kell megtennie.

- **Az ügyfél elfogadta Microsoft Ügyfélszerződés partneri igazoláson keresztül**
...
- Ez a funkció csak olyan áttevő partnerek számára érhető el, akik már meglévő közvetlen számlázási partnerbérlőik használatával befejezték a közvetett viszonteladói regisztrációt.

- Az adott ügyfélhez társított előfizetések átadása előtt az áttűnéspartnernek közvetett szolgáltatóra kell áthelyeznie az ügyfelet.

- Az ügyfélnek el kell [fogadnia Microsoft Ügyfélszerződés közvetett szolgáltatón keresztül.](#microsoft-customer-agreement-acceptance)

### <a name="how-to-transition-to-indirect-reseller-status"></a>Váltás közvetett viszonteladói állapotra
...
- A közvetett szolgáltató ellenőrzi, hogy az átadási kérelem befejeződött-e.
...
### <a name="indirect-provider---accept-transfer-request"></a>Közvetett szolgáltató – átadási kérelem elfogadása

Átadási kérelem áttekintése és elfogadása közvetett szolgáltatóként:

1. Jelentkezzen be a Partnerközpont **rendszergazdai ügynökként** vagy **értékesítési ügynökként.**

2. Az Ügyfelek **lapon** válassza ki a kívánt ügyfelet, és kattintson a Gyorshivatkozások ikonra az ügyfél összefoglaló nézetének kibontásához.

3. A **Közvetett viszonteladó(k) alatt ellenőrizze,** hogy az áttűnéspartner szerepel-e a listán.
...
### <a name="indirect-provider---verify-transfer-request-is-complete"></a>Közvetett szolgáltató – az átadási kérelem befejezésének ellenőrzése
...
6. Ellenőrizze, hogy az előfizetés(ök) már nem aktívként jelennek-e meg az **Előfizetések** lapon:

   1. Ha ez egy Azure-előfizetés (MS-AZR-0145P), akkor a továbbiakban nem fog szerepelni a listán.
...
- **Az előfizetés azonosítója az átvitel után eltérő lesz.** Ha ez egy Azure-előfizetés (MS-AZR-0145P), akkor egy Azure-előfizetés-azonosítóval is rendelkezik, amelyet az előző tulajdonos őriz meg, és megjelenik az Azure felügyeleti portálon.
